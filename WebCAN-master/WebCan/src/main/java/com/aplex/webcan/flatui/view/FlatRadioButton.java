...
public class FlatRadioButton extends RadioButton implements AttributeChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray uncheckedEnabled = this.getContext().obtainStyledAttributes(attrs, styleable.fl_FlatRadioButton);
            ...
            this.attributes.setBorderWidth(uncheckedEnabled.getDimensionPixelSize(0, Attributes.DEFAULT_BORDER_WIDTH_PX));
        ...
        checkedOutside1.setCornerRadius((float)this.attributes.getSize());
        ...
        checkedCore.setCornerRadius((float)this.attributes.getSize());
