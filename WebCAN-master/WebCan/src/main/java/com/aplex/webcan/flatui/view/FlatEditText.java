...
public class FlatEditText extends EditText implements AttributeChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            TypedArray backgroundDrawable = this.getContext().obtainStyledAttributes(attrs, styleable.fl_FlatEditText);
