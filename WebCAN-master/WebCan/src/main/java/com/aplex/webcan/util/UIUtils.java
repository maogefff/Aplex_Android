...
import com.aplex.webcan.BaseApplication;
...
public class UIUtils
{
	 ...
	 * @param runnable
	 */
	public static void SafeExecuteRunnable(Runnable runnable){
		getMainHandler().post(runnable);
	}
	public static void SafeExecuteRunnableDelayed(Runnable runnable,long delayMillis){
